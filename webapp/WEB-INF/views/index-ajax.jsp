...
$(function(){
	var dialogDelete=$("#dialog-delete-form").dialog({
		...
		buttons:{
			"삭제":function(){
				...
				$.ajax({
					url:"/guestbook3/ajax/delete?no="+no+"&password="+$("#password-delete").val(),
					type:"get",
					dataType:"json",
					data:"",
					success: function(response){
	...
	$("#add-form").submit(function(event){
		...
		$.ajax({
			url:"/guestbook3/ajax/add?name="+name+"&password="+password+"&message="+message,
			type:"get",
			dataType:"json",
			data:"",
			success: function(response){
